...
**Project:** Stellar Institute
**Generated:** 2026-06-17
**Category:** Luxury/Premium Education Brand

---

## Global Rules

### Color Palette (STRICT ORIGINAL)

| Role | Hex | CSS Variable |
|------|-----|--------------|
| Primary | `#0a2540` | `--primary` |
| Primary Light | `#2e3192` | `--primary-light` |
| Accent/CTA | `#00b4d8` | `--accent-cyan` |
| Background | `#ffffff` | `--bg-color` |
| Background Alt| `#f8fafc` | `--bg-color-alt` |
| Text Main | `#334155` | `--text-main` |
| Text Muted | `#64748b` | `--text-muted` |
| Text Light | `#ffffff` | `--text-light` |

**Color Notes:** Original professional educational palette (Navy Blue, Indigo, Cyan).
...
**Best For:** Premium SaaS, high-end education, creative platforms, branding experiences, luxury portfolios
...
- **Conversion Strategy:** Show real screenshots. Include ratings (4.5+ stars). Platform-specific CTAs.
- **Section Order:** 1. Hero with interactive Three.js canvas, 2. Stats & Accreditations carousel, 3. Features with icons, 4. Reviews/ratings, 5. CTAs
